...
const Footer = () => (
    <footer>
        <div class="footer-area footer-padding footer-bg" style={{backgroundImage: 'url("../footer_bg.jpg")'}}>
            <div class="container">
                       ...
                       <div class="single-footer-caption mb-50">
                         <div class="single-footer-caption mb-30">
                             <div class="footer-logo">
                                 <a href="index.html"><img src={process.env.PUBLIC_URL + 'logo.jpg'} width={100} alt=""/></a>
                             </div>
